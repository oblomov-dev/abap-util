...
CREATE OBJECT lo_range TYPE zabaputil_cl_util_range EXPORTING iv_fieldname = `CARRID` ir_range = temp1.
  ...
  METHOD test_eq_include.
    ...
    DATA temp2 TYPE zabaputil_cl_util_context=>ty_t_range.
...
CREATE OBJECT lo_range TYPE zabaputil_cl_util_range EXPORTING iv_fieldname = `CARRID` ir_range = temp7.
  ...
  METHOD test_gt_include.
    ...
    DATA temp8 TYPE zabaputil_cl_util_context=>ty_t_range.
...
CREATE OBJECT lo_range TYPE zabaputil_cl_util_range EXPORTING iv_fieldname = `AMOUNT` ir_range = temp13.
  ...
  METHOD test_lt_include.
    ...
    DATA temp14 TYPE zabaputil_cl_util_context=>ty_t_range.
...
CREATE OBJECT lo_range TYPE zabaputil_cl_util_range EXPORTING iv_fieldname = `AMOUNT` ir_range = temp16.
  ...
  METHOD test_le_include.
    ...
    DATA temp17 TYPE zabaputil_cl_util_context=>ty_t_range.
...
CREATE OBJECT lo_range TYPE zabaputil_cl_util_range EXPORTING iv_fieldname = `AMOUNT` ir_range = temp19.
  ...
  METHOD test_bt_include.
    ...
    DATA temp20 TYPE zabaputil_cl_util_context=>ty_t_range.
...
CREATE OBJECT lo_range TYPE zabaputil_cl_util_range EXPORTING iv_fieldname = `AMOUNT` ir_range = temp22.
  ...
  METHOD test_nb_include.
    ...
    DATA temp23 TYPE zabaputil_cl_util_context=>ty_t_range.
...
CREATE OBJECT lo_range TYPE zabaputil_cl_util_range EXPORTING iv_fieldname = `AMOUNT` ir_range = temp25.
  ...
  METHOD test_cp_include.
    ...
    DATA temp26 TYPE zabaputil_cl_util_context=>ty_t_range.
...
CREATE OBJECT lo_range TYPE zabaputil_cl_util_range EXPORTING iv_fieldname = `NAME` ir_range = temp28.
  ...
  METHOD test_np_include.
    ...
    DATA temp29 TYPE zabaputil_cl_util_context=>ty_t_range.
...
CREATE OBJECT lo_range TYPE zabaputil_cl_util_range EXPORTING iv_fieldname = `NAME` ir_range = temp31.
  ...
  METHOD test_exclude_sign.
    ...
    DATA temp32 TYPE zabaputil_cl_util_context=>ty_t_range.
...
CREATE OBJECT lo_range TYPE zabaputil_cl_util_range EXPORTING iv_fieldname = `CARRID` ir_range = temp34.
  ...
  METHOD test_multiple_entries.
    ...
    DATA temp35 TYPE zabaputil_cl_util_context=>ty_t_range.
...
CREATE OBJECT lo_range TYPE zabaputil_cl_util_range EXPORTING iv_fieldname = `CARRID` ir_range = temp37.
  ...
  METHOD test_quote_escape.
    ...
    DATA temp38 TYPE zabaputil_cl_util_context=>ty_t_range.
...
CREATE OBJECT lo_range TYPE zabaputil_cl_util_range EXPORTING iv_fieldname = `NAME` ir_range = temp40.
  ...
  METHOD test_fieldname_upper.
    ...
    DATA temp41 TYPE zabaputil_cl_util_context=>ty_t_range.
...
CREATE OBJECT lo_range TYPE zabaputil_cl_util_range EXPORTING iv_fieldname = `carrid` ir_range = temp43.
  ...
  METHOD test_constants.
    ...
    cl_abap_unit_assert=>assert_equals( exp = `I`  act = zabaputil_cl_util_range=>signs-including ).
    cl_abap_unit_assert=>assert_equals( exp = `E`  act = zabaputil_cl_util_range=>signs-excluding ).
    cl_abap_unit_assert=>assert_equals( exp = `EQ` act = zabaputil_cl_util_range=>options-equal ).
    cl_abap_unit_assert=>assert_equals( exp = `NE` act = zabaputil_cl_util_range=>options-not_equal ).
    cl_abap_unit_assert=>assert_equals( exp = `BT` act = zabaputil_cl_util_range=>options-between ).
    cl_abap_unit_assert=>assert_equals( exp = `NB` act = zabaputil_cl_util_range=>options-not_between ).
    cl_abap_unit_assert=>assert_equals( exp = `CP` act = zabaputil_cl_util_range=>options-contains_pattern ).
    cl_abap_unit_assert=>assert_equals( exp = `NP` act = zabaputil_cl_util_range=>options-not_contains_pattern ).
    cl_abap_unit_assert=>assert_equals( exp = `GT` act = zabaputil_cl_util_range=>options-greater_than ).
    cl_abap_unit_assert=>assert_equals( exp = `GE` act = zabaputil_cl_util_range=>options-greater_equal ).
    cl_abap_unit_assert=>assert_equals( exp = `LE` act = zabaputil_cl_util_range=>options-less_equal ).
    cl_abap_unit_assert=>assert_equals( exp = `LT` act = zabaputil_cl_util_range=>options-less_than ).
  ...
  METHOD test_factory_with_sql.
    ...
    DATA temp44 TYPE zabaputil_cl_util_context=>ty_t_range.
...
CREATE OBJECT lo_range TYPE zabaputil_cl_util_range EXPORTING iv_fieldname = `CARRID` ir_range = temp46.
  ...
  METHOD test_get_sql_multi.
    ...
    DATA temp47 TYPE zabaputil_cl_util_context=>ty_t_range.
    DATA lt_r1 LIKE temp47.
    DATA temp49 TYPE zabaputil_cl_util_context=>ty_t_range.
    DATA lt_r2 LIKE temp49.
    DATA temp51 LIKE REF TO lt_r1.
DATA lv_sql1 TYPE string.
DATA temp1 TYPE REF TO zabaputil_cl_util_range.
...
CREATE OBJECT temp1 TYPE zabaputil_cl_util_range EXPORTING iv_fieldname = `CARRID` ir_range = temp51.
lv_sql1 = temp1->get_sql( ).
    
    GET REFERENCE OF lt_r2 INTO temp52.


CREATE OBJECT temp2 TYPE zabaputil_cl_util_range EXPORTING iv_fieldname = `CONNID` ir_range = temp52.
