CLASS zabaputil_cl_util_msg DEFINITION PUBLIC
  FINAL CREATE PUBLIC.
  PUBLIC SECTION.
...
CLASS zabaputil_cl_util_msg IMPLEMENTATION.
  ...
  METHOD msg_get_internal.
    ...
    DATA lv_kind TYPE string.
        ...
        DATA temp76 TYPE zabaputil_cl_util_context=>ty_s_msg.
        ...
        DATA ls_attri LIKE REF TO temp77.
          ...
          DATA temp80 TYPE zabaputil_cl_util_context=>ty_s_msg.
    lv_kind = zabaputil_cl_util_context=>rtti_get_type_kind( val ).
    CASE lv_kind.
      ...
      WHEN OTHERS.
        ...
        IF zabaputil_cl_util_context=>rtti_check_clike( val ) IS NOT INITIAL.
  ...
  METHOD msg_get_collect.
    ...
    DATA temp5 TYPE zabaputil_cl_util_context=>ty_t_msg.
  ...
  METHOD msg_get_rap.
    ...
    FIELD-SYMBOLS <fail> TYPE any.
      FIELD-SYMBOLS <cause> TYPE any.
        ...
        DATA temp87 TYPE zabaputil_cl_util_context=>ty_s_msg.
    DATA lt_attri TYPE abap_component_tab.
  ...
  METHOD msg_get_rap_flatten.
    ...
    LOOP AT lt_attri REFERENCE INTO ls_attri.
      ...
      lv_sub_kind = zabaputil_cl_util_context=>rtti_get_type_kind( <comp> ).
  ...
  METHOD msg_get_rap_meta.
    ...
    DATA lv TYPE string.
      DATA temp92 TYPE zabaputil_cl_util_context=>ty_s_name_value.
      DATA temp93 TYPE zabaputil_cl_util_context=>ty_s_name_value.
      DATA temp94 TYPE zabaputil_cl_util_context=>ty_s_name_value.
      DATA temp95 TYPE zabaputil_cl_util_context=>ty_s_name_value.
      DATA temp96 TYPE zabaputil_cl_util_context=>ty_s_name_value.
      DATA temp97 TYPE zabaputil_cl_util_context=>ty_s_name_value.
