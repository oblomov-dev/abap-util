...
CLASS ltcl_unit_test_msg_mapper IMPLEMENTATION.
  ...
  METHOD test_sy.
    ...
    DATA lt_result TYPE zabaputil_cl_util_context=>ty_t_msg.
  ...
  METHOD test_rap_via_get.
    ...
    lt_result = zabaputil_cl_util_msg=>msg_get( <failed> ).
    ...
    lv_text = zabaputil_cl_util_msg=>msg_get_text( <failed> ).
    cl_abap_unit_assert=>assert_not_initial( lv_text ).
  ...
  METHOD test_collect.
    ...
    lv_collected = zabaputil_cl_util_msg=>msg_get_collect( lt_msg ).
  ...
  METHOD test_collect_empty.
    ...
    DATA lv_collected TYPE string.
    lv_collected = zabaputil_cl_util_msg=>msg_get_collect( lt_empty ).
  ...
  METHOD test_rap_other.
    ...
    lt_result = zabaputil_cl_util_msg=>msg_get( <reported> ).
  ...
  METHOD test_fallback.
    ...
    lt_result = zabaputil_cl_util_msg=>msg_get( val = lt_empty val2 = lt_full ).
  ...
  METHOD test_fallback_skip.
    ...
    lt_result = zabaputil_cl_util_msg=>msg_get( val = lt_first val2 = lt_second ).
