...
CLASS ltcl_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    DATA mo_cut    TYPE REF TO zabaputil_cl_http.
...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD setup.
    ...
    mo_cut = zabaputil_cl_http=>factory( mo_server ).
  ...
  METHOD test_factory_cloud.
    ...
    DATA lo_cut TYPE REF TO zabaputil_cl_http.
    ...
    lo_cut = zabaputil_cl_http=>factory_cloud( req = temp1
                                                      res     = temp2 ).
  ...
  METHOD test_get_response_cookie.
    ...
    DATA temp9 TYPE zabaputil_cl_util_context=>ty_s_name_value.
    CLEAR temp9.
