...
DATA lt_cols TYPE temp2.
  ...
  METHOD json_stringify.
    TRY.
        ...
        DATA temp22 TYPE REF TO zoblomov_if_ajson.
        temp22 ?= zoblomov_cl_ajson=>create_empty( ).
...
|x, nsis, objectivec, ocaml, pascal, perl, pgsql, php, plain_text, powershell, praat, prolog, properties, protobuf, python, r, razor, rdoc, rhtml, rst, ruby, rust, sass, scad, scala, scheme, scss, sh, sjs, smarty, snippets, soy_template, space, sql,| &&
  ...
  METHOD url_param_get.
    ...
    CLEAR temp42.
    DATA temp43 TYPE zoblomov_cl_util=>ty_s_name_value.
...
*                      v = c_trim_lower( lv_value ) ) INTO TABLE rt_params.
      DATA temp46 TYPE zoblomov_cl_util=>ty_s_name_value.
      CLEAR temp46.
      temp46-n = lv_name.
      temp46-v = lv_value.
  ...
  METHOD url_param_set.
    ...
    ENDLOOP.
    IF sy-subrc <> 0.
      DATA temp48 TYPE zoblomov_cl_util=>ty_s_name_value.
      CLEAR temp48.
      temp48-n = lv_n.
...
CREATE OBJECT lo_range TYPE zoblomov_cl_util_range EXPORTING iv_fieldname = ls_filter-name ir_range = temp53.
