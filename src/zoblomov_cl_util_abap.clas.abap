CLASS zoblomov_cl_util_abap DEFINITION
  ...
  PROTECTED SECTION.
    ...
    CLASS-METHODS _get_e071k_tabkey
      IMPORTING
        line             TYPE any
        dfies            TYPE zoblomov_cl_util=>ty_t_dfies
      RETURNING
...
*        DATA(ls_row) = CORRESPONDING #( <shlp2>[ 1 ] OPTIONAL ).
    ...
    LOOP AT ms_shlp-interface INTO interface.
      ...
      IF interface-value IS NOT INITIAL.
        ...
        DATA temp2 TYPE zoblomov_cl_util_abap=>ty_shlp_descr-selopt.
        CLEAR temp2.
        temp2 = ms_shlp-selopt.
        DATA temp3 LIKE LINE OF temp2.
        temp3-shlpfield = interface-shlpfield.
        temp3-shlpname = interface-valtabname.
        DATA temp9 TYPE zoblomov_cl_util_abap=>ty_ddshselopt-option.
    ...
    LOOP AT ms_shlp-fieldprop INTO fieldrop.
      ...
      DATA temp4 TYPE zoblomov_cl_util_abap=>ty_shlp_descr-selopt.
      CLEAR temp4.
      temp4 = ms_shlp-selopt.
      DATA temp5 LIKE LINE OF temp4.
      temp5-shlpfield = fieldrop-fieldname.
      DATA temp10 TYPE zoblomov_cl_util_abap=>ty_ddshselopt-option.
    ...
    LOOP AT ms_shlp-fieldprop INTO field_props WHERE shlplispos IS NOT INITIAL.
      ...
      DATA temp6 TYPE zoblomov_cl_util_abap=>ty_s_dfies_2.
      CLEAR temp6.
      DATA temp7 TYPE zoblomov_cl_util_abap=>ty_s_dfies_2.
