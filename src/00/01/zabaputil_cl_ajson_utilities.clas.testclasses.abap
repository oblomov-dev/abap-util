...
CLASS lcl_nodes_helper DEFINITION FINAL.
  PUBLIC SECTION.
    ...
    DATA mt_nodes TYPE zabaputil_if_ajson_types=>ty_nodes_tt READ-ONLY.
...
CLASS ltcl_json_utils DEFINITION
  ...
  PRIVATE SECTION.
    ...
    METHODS json_diff FOR TESTING RAISING zabaputil_cx_ajson_error.
    METHODS json_diff_types FOR TESTING RAISING zabaputil_cx_ajson_error.
    METHODS json_diff_arrays FOR TESTING RAISING zabaputil_cx_ajson_error.
    METHODS json_merge FOR TESTING RAISING zabaputil_cx_ajson_error.
    METHODS json_sort FOR TESTING RAISING zabaputil_cx_ajson_error.
    METHODS is_equal FOR TESTING RAISING zabaputil_cx_ajson_error.

    METHODS iterate_array FOR TESTING RAISING zabaputil_cx_ajson_error.
    METHODS iterate_object FOR TESTING RAISING zabaputil_cx_ajson_error.
...
CLASS ltcl_json_utils IMPLEMENTATION.
  ...
  METHOD json_diff.
    ...
    DATA:
      lv_json       TYPE string,
      lo_util       TYPE REF TO zabaputil_cl_ajson_utilities,
      lo_insert     TYPE REF TO zabaputil_if_ajson,
      lo_delete     TYPE REF TO zabaputil_if_ajson,
      lo_change     TYPE REF TO zabaputil_if_ajson,
...
*      '        "row": 4,\n' && " array delete
  ...
  METHOD json_merge.
    ...
    DATA:
      ...
      lv_json_b    TYPE string,
      lo_util      TYPE REF TO zabaputil_cl_ajson_utilities,
      lo_merge     TYPE REF TO zabaputil_if_ajson,
  ...
  METHOD is_equal.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zabaputil_cl_ajson_utilities=>new( )->is_equal(
        ii_json_a = zabaputil_cl_ajson=>parse( '{"a":1,"b":2}' )
        ii_json_b = zabaputil_cl_ajson=>parse( '{"a":1,"b":2}' ) )
      exp = abap_true ).
  ...
  METHOD iterate_array.
    ...
    DATA li_iterator TYPE REF TO zabaputil_if_ajson_iterator.
    DATA lx TYPE REF TO zabaputil_cx_ajson_error.
    DATA lt_data TYPE TABLE OF string.
    DATA li_json_item TYPE REF TO zabaputil_if_ajson.
    ...
    li_iterator = zabaputil_cl_ajson_utilities=>iterate_array(
      ii_json = li_cut
      iv_path = '/b' ).
    ...
    TRY.
        zabaputil_cl_ajson_utilities=>iterate_array(
        ii_json = li_cut
        iv_path = '/notexisting' ).
  ...
  METHOD iterate_object.
    ...
    li_iterator = zabaputil_cl_ajson_utilities=>iterate_object(
      ii_json = li_cut
      iv_path = '/b' ).
    WHILE li_iterator->has_next( ) = abap_true.
      li_json_item = li_iterator->next( ).
    ...
    TRY.
        zabaputil_cl_ajson_utilities=>iterate_object(
        ii_json = li_cut
        iv_path = '/notexisting' ).
        cl_abap_unit_assert=>fail( ).
      CATCH zabaputil_cx_ajson_error INTO lx.
